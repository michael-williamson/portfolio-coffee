let projects =  [      
        ...
        },        
        {
            ...
            "site":"https://trade-buddy-app.herokuapp.com/",
            "code":"https://github.com/michael-williamson/trade_buddy",
            "image":"/images/trade_buddy.png"
        },        
        {
            "title": "Livewell Fishing App",
            "tech": ["React.js","MongoDB","Express.js"],
            "description":"Full Stack App for fishing enthusiasts to keep track of the fish they catch",
            "site":"https://livewell-app.herokuapp.com/view-fish",
            "code":"https://github.com/michael-williamson/Livewell-App",
            "image":"/images/livewell_app.png"
        },        
        {
            "title": "Brewpub Site",
            "tech": ["CSS animations","Responsive","Optimization"],
            "description":"An experimental design for what a brewpub website would like with promotions, list of what's on tap, and what events are coming soon.  Complete with CSS Animations smooth-scrolling and Web Optimized Media.",
            "site":"https://michael-williamson.github.io/frontier-brew-pub/",
            "code":"https://github.com/michael-williamson/frontier-brew-pub",
            "image":"/images/brewpub-app.jpg"
        },    
        {
            "title": "Yoga Site",
            "tech": ["HTML Tables","Animations","Color Theme"],
            "description":"Experimental site based on bringing to life the website of a potential yoga business client. Covers all of the necessities of information such as instructor info, class times, and class descriptions.  As well incorporated CSS transforms and transitions for interactivity.",
        ...
        {
            "title": "Planet App",
            "tech": ["JavaScript Equations","Photoshop","Info Site"],
            "description":"Interactive and fun app using graphics ands movement to create a pleasant experience learning about the planets in our Solar System.  Used JavaScript Trigonometry to get a circular rotation.",
