let projects = [
  {
    ...
    description:
      "Full Stack App for fishing enthusiasts to keep track of the fish they catch",
  ...
  },
  {
    ...
    tech: ["React.js", "TypeScript", "Java Spring Boot"],
    description:
      "Full Stack App designed to assist Stock Traders in analyzing and keeping up-to-date with their stock trades",
  ...
  },
  {
    ...
    description:
      "Interactive and fun app using graphics ands movement to create a pleasant experience learning about the planets in our Solar System.  Used JavaScript Trigonometry to get a circular rotation.",
