let projects =  [
        ...
        {
            "title": "Motorcycle Weather Tracker",
            "description":"App built using the React library and GraphQL making ajax calls to the Weather Underground API and comparing the returned to determine riding conditions.",
            "site":"https://motorcycle-weather-tracker.herokuapp.com/#/",
            "code":"https://github.com/michael-williamson/motorcycle_weather_tracker",
            "image":"/images/moto-weather.jpg"
        },
        {
            "title": "Yoga Site",
            "description":"Experimental site based on bringing to life the website of a potential yoga business client. Covers all of the necessities of information such as instructor info, class times, and class descriptions.",
        ...
        {
            "title": "Planet App",
            "description":"Interactive and fun app using graphics ands movement to create a pleasant experience learning about the planets in our Solar System.",
